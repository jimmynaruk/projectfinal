...
<label>รหัสขนม:</label><input type="text" id="idtxt" name="idtxt[]"  value="{{$var->product_id}}" class="form-control"readonly>
<label>จำนวนขนม:</label><input type="text" id="vitytxt" name="vitytxt[]"  value="{{$var->Amount}}" class="form-control"readonly></br>
@endforeach
