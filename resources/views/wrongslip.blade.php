...
<h2><center>สถานะการทำรายการ<center> </h2>
            ...
            <table id="example" class="display nowrap" style="width:100%">
                    <thead>
                        <tr>
							...
							<th>สถานะรายการ</th>
							<th>รายละเอียด</th>
							<th>แก้ไขสลิปโอนเงิน</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                    @foreach($dataset['silpedit'] as $var)
                    ...
                    <tr> 
						...
						<td>
                        <button type="button"  class="btn btn-warning" onclick="checkmodal('{{$var->order_id}}')" >
               <span class="fa fa-money"  aria-hidden="true"></span>&nbsp;แก้ไขสลิปโอนเงิน</button>
